export class ProductService {
   ...
   */
  static async getProducts({admin}) {
    try {
      const { data: { products: { edges } } } = await ProductService.fetchProductsFromShopify({admin});
   ...
   */
  static async fetchProductsFromShopify({admin}) {
